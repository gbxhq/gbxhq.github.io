<? if(!defined('IN_DZZ')) exit('Access Denied'); /*a:1:{s:81:"/home/oowin/domains/oo1.win/public_html/win/./dzz/player/mp3/template/jplayer.htm";i:1492235058;}*/?>
<!DOCTYPE html>
<html>
<head>
...
<link href="<?php echo MP3_DIR;?>images/jplayer.pink.flag.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css" />
<script src="<?php echo MP3_DIR;?>scripts/jquery-1.7.2.min.js" type="text/javascript"></script>
<script src="dzz/scripts/jquery.json-2.4.min.js" type="text/javascript"></script>
<script src="<?php echo MP3_DIR;?>scripts/jquery.jplayer.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script src="<?php echo MP3_DIR;?>scripts/jplayer.playlist.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script src="./data/template/dzz_player_mp3_jplayer_dzz_api_zh-cn.js" type="text/javascript"></script><script src="dzz/scripts/dzz.api.js?<?php echo VERHASH;?>" type="text/javascript"></script>
<script type="text/javascript">

var jplay=null;

var url='<?php echo DZZSCRIPT;?>?mod=player:mp3&op=jplayer';
var streamurl='<?php echo DZZSCRIPT;?>?mod=io&op=getStream';
var icoid='<?php echo $icoid;?>';
...
json.playlist, 
{
swfPath: "<?php echo MP3_DIR;?>scripts",
supplied: "mp3",
wmode: "window",
playlistOptions: {
...
parent.OpenFile('open','播放器mp3文件',{"mp3":['mp3文件(*.MP3)',['MP3'],'selected']},{bz:'all',multiple:true},function(data){
acceptdata(data);
}); 
return false;
});
