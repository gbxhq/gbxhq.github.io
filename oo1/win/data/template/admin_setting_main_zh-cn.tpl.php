<? if(!defined('IN_DZZ')) exit('Access Denied'); /*a:6:{s:77:"/home/oowin/domains/oo1.win/public_html/win/./admin/setting/template/main.htm";i:1492235054;s:98:"/home/oowin/domains/oo1.win/public_html/win/./core/template/default/common/header_simple_start.htm";i:1492235056;s:96:"/home/oowin/domains/oo1.win/public_html/win/./core/template/default/common/header_simple_end.htm";i:1492235056;s:77:"/home/oowin/domains/oo1.win/public_html/win/./admin/setting/template/left.htm";i:1492235054;s:87:"/home/oowin/domains/oo1.win/public_html/win/./core/template/default/common/seccheck.htm";i:1492235056;s:92:"/home/oowin/domains/oo1.win/public_html/win/./core/template/default/common/footer_simple.htm";i:1489490190;}*/?>
<!DOCTYPE html>
<html>
<head>
...
</style><script src="./data/template/admin_setting_main_dzz_api_zh-cn.js" type="text/javascript"></script><script src="dzz/scripts/dzz.api.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<script src="./data/template/admin_setting_main__fun_zh-cn.js" type="text/javascript"></script><script src="dzz/scripts/_fun.js?<?php echo VERHASH;?>" type="text/javascript"></script>
</head>
  ...
  <div class="bs-main-container  clearfix"> 
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        ...
        <dd class="clearfix">
          <div class="dropdown">
            ...
            <button type="button" id="defaultdepartment_Menu" class="btn btn-default dropdown-toggle" data-toggle="dropdown"> <?php echo $defaultdepartment;?> <span class="caret"></span> </button>
      ...
      <dl>
        ...
        <dd class="clearfix">
          <dl>
            <dd class="clearfix"> <span class="label label-default" style="display:inline-block;padding:10px 15px;margin-right:10px;">小图尺寸</span>
              <input name="settingnew[thumbsize][small][width]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="宽度" value="<?php echo $setting[thumbsize][small][width]?$setting[thumbsize][small][width]:'256'?>" />
              <span style="display:inline-block;padding:6px 3px">X</span>
              <input name="settingnew[thumbsize][small][height]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="高度" value="<?php echo $setting[thumbsize][small][height]?$setting[thumbsize][small][height]:'256'?>" />
            </dd>
          </dl>
          <dl>
            <dd class="clearfix"> <span class="label label-default" style="display:inline-block;padding:10px 15px;margin-right:10px;">中图尺寸</span>
              <input name="settingnew[thumbsize][middle][width]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="宽度" value="<?php echo $setting[thumbsize][middle][width]?$setting[thumbsize][middle][width]:'800'?>" />
              <span style="display:inline-block;padding:6px 3px">X</span>
              <input name="settingnew[thumbsize][middle][height]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="高度" value="<?php echo $setting[thumbsize][middle][height]?$setting[thumbsize][middle][height]:'600'?>" />
            </dd>
          </dl>
          <dl>
            <dd class="clearfix"> <span class="label label-default" style="display:inline-block;padding:10px 15px;margin-right:10px;">大图尺寸</span>
              <input name="settingnew[thumbsize][large][width]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="宽度" value="<?php echo $setting[thumbsize][large][width]?$setting[thumbsize][large][width]:'1440'?>" />
              <span style="display:inline-block;padding:6px 3px">X</span>
              <input name="settingnew[thumbsize][large][height]" class="form-control" style="display:inline-block;float:none;width:60px" placeholder="高度" value="<?php echo $setting[thumbsize][large][height]?$setting[thumbsize][large][height]:'900'?>" />
            </dd>
          </dl>
          <ul class="help-block">
            <li>系统缩略图尺寸规格</li>
      ...
      <dl>
        <dt>文件分享:</dt>
        <dd class="clearfix">
          <label class="radio-inline "><input type="radio" name="settingnew[allowshare]" value="0"<?php if(!$setting['allowshare']) { ?>checked<?php } ?> onclick="$('dl_innerShare').style.display='block'">启用</label>
          <label class="radio radio-inline"><input type="radio" name="settingnew[allowshare]" value="1"<?php if($setting['allowshare']) { ?>checked<?php } ?> onclick="$('dl_innerShare').style.display='none'">禁用</label>
          <span class="help-inline"> 禁用分享，文件属性页中不再出现分享和下载链接，Dzz文档，网址和网络视频类除外</span>
        </dd>
        <dd class="clearfix">
          <dl id="dl_innerShare" class="mt20">
            <dt>内部分享:</dt>
            <dd class="clearfix">
              <label class="radio-inline "><input type="radio" name="settingnew[innerShare]" value="1"<?php if($setting['innerShare']) { ?>checked<?php } ?>>启用</label>
              <label class="radio radio-inline"><input type="radio" name="settingnew[innerShare]" value="0"<?php if(!$setting['innerShare']) { ?>checked<?php } ?>>禁用</label>
              <span class="help-block"> 禁用内部分享，分享属性页中不再出现内部分享链接</span> </dd>
          </dl>
        </dd>
      </dl>
      <dl>
        ...
        <dl>
     P3P    P3P                    P�N            �F    �3P            p3P     @      p3P            s="form-control" id="metadescription" name="settingnew[metadescription]" row="6"><?php echo $setting['metadescription'];?></textarea>
...
jQuery('#sel_' + ctrlid).val(vals[0].orgid);
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        <dt>上传权限设置</dt>
        <p class="text-danger ml20"> 注： 用户私有云(我的云中用户添加的云)不做限制，所以此处的设置的”默认空间“对用户私有云不起作用。 </p>
        <?php if(is_array($usergroups)) foreach($usergroups as $value) { ?>        <dd class="clearfix">
          <dl>
            <dt><?php echo $value['grouptitle'];?></dt>
            <dd class="clearfix"> <span class="pull-left mr20" style="padding:6px;">默认空间</span>
              <div class="input-group" style="width:120px;float:left">
            ...
            <dd class="clearfix mt10"> <span class="pull-left mr20" style="padding:6px;">文件大小</span>
              <div class="input-group" style="width:120px;float:left">
            ...
            <dd class="clearfix mt10"> <span class="pull-left mr20" style="padding:6px;">文件类型</span>
      ...
      <dl>
        ...
        <dd class="clearfix">
          <select name="settingnew[desktop_default][iconview]" class="form-control">
            ...
            <option value="<?php echo $value['id'];?>" <?php if($value[ 'id']==$setting['desktop_default']['iconview']) { ?>selected="selected" 
        ...
        <dd class="clearfix"> <span class="help-inline">默认的桌面图标大小。（用户设置后，以用户设置为准）</span> </dd>
      </dl>
      <dl>
        <dt>图标排列位置：</dt>
        <dd class="clearfix">
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        <dt>是否开启QQ登录：</dt>
        <dd class="clearfix">
          <label class="radio-inline "><input type="radio" name="settingnew[qq_login]" value="0" <?php if(!$setting['qq_login']) { ?>checked<?php } ?> onclick="jQuery('#qqlogin_wrapper').addClass('hide');">不启用</label>
          <label class="radio-inline "><input type="radio" name="settingnew[qq_login]" value="1" <?php if($setting['qq_login']=='1') { ?>checked<?php } ?> onclick="jQuery('#qqlogin_wrapper').removeClass('hide');">启用</label>
        </dd>
      </dl>
      <div id="qqlogin_wrapper" <?php if(!$setting['qq_login']) { ?>class="hide" 
      <?php } ?>>
      <dl>
        <dt>QQ APPID：</dt>
        <dd class="clearfix">
          <input type="text" class="form-control" name="settingnew[qq_appid]" value="<?php echo $setting['qq_appid'];?>" />
        </dd>
        <dd class="clearfix"> <span class="help-inline">在QQ互联申请的应用APP ID</span> </dd>
      </dl>
      <dl>
        <dt>QQ APPKAY：</dt>
        <dd class="clearfix">
          <input type="text" class="form-control" name="settingnew[qq_appkey]" value="<?php echo $setting['qq_appkey'];?>" />
        </dd>
        <dd class="clearfix"> <span class="help-inline">在QQ互联申请的应用APP KEY</span> </dd>
      </dl>
      <dl>
        <dt>是否允许直接使用：</dt>
        <dd class="clearfix">
          <label class="radio-inline "><input type="radio" name="settingnew[qq_bind]" value="1" <?php if($setting['qq_bind']=='1') { ?>checked<?php } ?>>必须绑定用户</label>
          <label class="radio-inline "><input type="radio" name="settingnew[qq_bind]" value="0" <?php if(!$setting['qq_bind']) { ?>checked<?php } ?>>允许�P3P    P3P                    P�N            �F    �3P            p3P     @      p3P            ��用户，直接使用的话，系统将根据QQ的信息自动添加用户到系统并且和此QQ绑定。用户名和姓名默认使用QQ昵称；邮箱、密码随机生成。用户可以通过QQ登录正常登录或找回密码</span> </dd>
      </dl>
      <dl>
        <dt>回调地址：</dt>
        <dd class="clearfix"> <b class="help-inline"><?php echo $_G['siteurl'];?>user.php</b> </dd>
      </dl>
      </div>
      <dl>
        <dd>
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        ...
        <dd class="clearfix"> <span class="help-inline">启用独立登录页后，未登录用户默认首页为此登录页。</span> </dd>
      </dl>
      <dl>
        <dt>页面主标题：</dt>
        <dd class="clearfix">
...
jQuery(obj).parent().parent().before(html);
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        ...
        <dd class="clearfix">
          <label class="checkbox-inline"><input type="checkbox" name="settingnew[strongpw][]" value="4" <?php if(in_array(4,$setting['strongpw'])) { ?>checked="chcked"<?php } ?> />特殊符号</label>
        </dd>
      ...
      <dl>
        ...
        <dd class="clearfix">
          ...
          <ul class="help-block">
            <li>系统发送的欢迎信息的内容。标题内容均支持变量替换，可以使用如下变量:</li><li>{username} : 用户名</li><li>{time} : 发送时间</li>
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        <dt>验证码类型:</dt>
        <dd class="clearfix">
          <label class="radio radio-inline"><input  type="radio" onclick="$('seccodeimageext').style.display = '';$('seccodeimagewh').style.display = '';" <?php if($setting['seccodedata']['type']<1) { ?>checked<?php } ?> value="0" name="settingnew[seccodedata][type]"> 英文图片验证码 </label>
        </dd>
        <dd class="clearfix">
          <label class="radio radio-inline"><input  type="radio" onclick="$('seccodeimageext').style.display = '';$('seccodeimagewh').style.display = '';" <?php if($setting['seccodedata']['type']==1) { ?>checked<?php } ?> value="1" name="settingnew[seccodedata][type]"> 中文图片验证码 </label>
        </dd>
        <dd class="clearfix">
          <label class="radio radio-inline"><input  type="radio" onclick="$('seccodeimageext').style.display = 'none';$('seccodeimagewh').style.display = '';" <?php if($setting['seccodedata']['type']==2) { ?>checked<?php } ?> value="2" name="settingnew[seccodedata][type]">  Flash 验证码 </label>
        </dd>
        <dd class="clearfix">
          <label class="radio radio-inline"><input  type="radio" onclick="$('seccodeimageext').style.display = 'none';$('seccodeimagewh').style.display = 'none';" <?php if($setting['seccodedata']['type']==3) { ?>checked<?php } ?> value="3" name="settingnew[seccodedata][type]"> 语音验证码 </label>
        </dd>
        <dd class="clearfix">
          <label class="radio radio-inline"><input  type="radio" onclick="$('seccodeimageext').style.display = 'none';$('seccodeimagewh').style.display = 'none';" <?php if($setting['seccodedata']['type']==99) { ?>checked<?php } ?> value="99" name="settingnew[seccodedata][type]">  位图验证码 </label>
        </dd>
...
?><?php unset($secshow);?><?php if(empty($secreturn)) { ?><?php echo $seccheckhtml;?><?php } ?> 
        ...
        <dl>
          ...
          <dd class="clearfix">
            ...
            <label class="radio radio-inline"><input  type="radio" <?php if($setting['seccodedata']['adulterate']<1) { ?P3P    P3P                    P�N            �F    �3P            p3P    !1      p3P            lass="help-block">选择“是”将给验证码背景增加随机的图形</span>
        </dl>
        <dl>
          <dt>随机 TTF 字体</dt>
          <dd class="clearfix">
    ...
    <form id="cpform" action="<?php echo BASESCRIPT;?>?mod=setting" class="form-horizontal-left" method="post" name="cpform">
      ...
      <dl>
        <dt>需要替换的敏感词:</dt>
        <dd class="clearfix">
          <textarea class="form-control" name="badwords" rows="10" style="width:100%" />
          <?php echo $badwords;?>
          </textarea>
      ...
      <dl>
        ...
        <dd class="clearfix">
          <div class="dropdown">
            ...
            <button type="button" id="syndepartment_Menu" class="btn btn-default dropdown-toggle" data-toggle="dropdown"> <?php echo $syndepartment;?> <span class="caret"></span> </button>
...
<script src="static/select2/select2_locale_<?php echo $checkLanguage;?>.js?<?php echo VERHASH;?>" type="text/javascript"></script> <?php updatesession();?><?php if(debuginfo()) { ?>
<script type="text/javascript">
try{
